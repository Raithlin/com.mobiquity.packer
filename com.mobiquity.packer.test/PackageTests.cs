...
namespace com.mobiquity.packer.test
{
    public class PackageTests
    {
        ...
        [Test]
        [TestCase("101 : (1,15.3,€34)")]
        public void Package_Constructor_WithPackageWeightTooLarge_Throws(string input)
        {
            Assert.Throws<APIException>(() => new PackageModel(input));
        }

        [Test]
        [TestCase("56 : (1,90.72,€13) (2,33.80,€40) (3,43.15,€10) (4,37.97,€16) (5,46.81,€36) (6,48.77,€79) (7,81.80,€45) (8,19.36,€79) (9,6.76,€64) (10,91.70,€23) (11,34.75,€40) (12,43.15,€12) (13,37.90,€26) (14,44.81,€33) (15,48.75,€70) (16,80.80,€44.44)")]
        public void Package_WithTooManyItems_Throws(string input)
        {
            Assert.Throws<APIException>(() => new PackageModel(input));
        }
        ...
        [TestCase("8 : (1,15.3,€34)", "-")]
        [TestCase("75 : (1,85.31,€29) (2,14.55,€74) (3,3.98,€16) (4,26.24,€55) (5,63.69,€52) (6,76.25,€75) (7,60.02,€74) (8,93.18,€35) (9,89.95,€78)", "2,7")]
        [TestCase("56 : (1,90.72,€13) (2,33.80,€40) (3,43.15,€10) (4,37.97,€16) (5,46.81,€36) (6,48.77,€79) (7,81.80,€45) (8,19.36,€79) (9,6.76,€64)", "8,9")]
        public void DeterminePackagesToInclude_ReturnsExpected(string input, string expectedResult)
        {
            var package = new PackageModel(input);
            package.DetermineItemsToInclude();
            if (package.ItemsToSend.Count > 0)
                Assert.AreEqual(expectedResult, string.Join(',', package.ItemsToSend));
            else
